...
verify:
	@forge verify-contract --chain-id 84532 --watch  --etherscan-api-key $(ETHERSCAN_API_KEY) --compiler-version 0.8.27 0x53F31F5eBa67eA0dde6b1b32682a2DB11E21c80f src/ExponentialBC/CultureBotFactory.sol:CultureBotFactory
