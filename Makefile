...
verify:
	@forge verify-contract --chain-id 84532 --watch --etherscan-api-key $(ETHERSCAN_API_KEY) --compiler-version 0.8.27 0x76B58C675d516702f8E72D8BD49eCD7CD623625c src/ExponentialBC/CultureBotFactory.sol:CultureBotFactory
