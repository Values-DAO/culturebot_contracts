...
contract CultureBotFactory is Context {
    ...
    function mint(
        ...
        CultureBotBoilerPlate(tokenAddy).tokenMint(amount);
    ...
    function retire(
        ...
        require(
            amount <= CultureBotBoilerPlate(tokenAddy).balanceOf(_msgSender()),
        ...
        CultureBotBoilerPlate(tokenAddy).tokenBurn(amount);
